...
export const staticsGuidesData: StaticsGuidesDataType = {
  ...
  ads: {
    description:
      'شما می‌توانید با معرفی شرکت‌، محصولات یا خدمات خودبا  در سایت رسمیو، از ظرفیت  بیش از ده‌ها هزار بازدید کننده روزانه سامانه رسمیو بهره‌مند شوید. بازدیدکنندگان رسمیو ،فعالان در عرصه تجارت و کسب‌وکار هستند از این رو می‌دانید که شانس دیده شدن تبلیغ توسط فرد درست به بالاترین میزان خود می‌‌رسد.',
    ...
    download: {
      text: 'دانلود کاتالوگ معرفی رسمیو',
  ...
  persons: {
    ...
    note: 'برای استفاده از این سرویس می‌بایست از یکی از اشتراک‌های رسمیو بهره‌مند باشید.',
    features: [
  ...
  api: {
    description:
      'امکانات رسمیو را بی واسطه در سایت‌ یا نرم‌افزارهای خود استفاده کنید. تنها ارائه دهنده این سرویس در کشور رسمیو است. این امکانات به شما این قابلیت را می‌دهد که صاحبین امضا را شناسایی کنید، در زمان صدور فاکتورها اطلاعات کمتری وارد کنید، دیتابیس‌های خود را بروز کنید و از چندین سرویس دیگر بهره‌مند شوید.',
...
export const staticPageContactUsData: StaticsContactUsDataType = {
  ...
  ads: {
    ...
    icon: <DownloadIcon />,
    action: {
      title: 'دانلود کاتالوگ معرفی رسمیو',
      url: 'https://s3.rasm.io/RasmioCatalogue.pdf',
    },
  },
  persons: {
...
export const descriptionData: DescriptionDataType = {
  'advanced-search': {
    ...
    answers: {
      title:
        'جواب این سوال‌ها فقط با ابزار جستجوی پیشرفته رسمیو قابل جوابگویی است',
      item: (
        <div data-selector='answer'>
          این سوال‌ها و هزاران سوال دیگر در ذهن فعالان اقتصادی است و تنها ابراز
          برای پاسخگویی به این سوالات جستجوی پیشرفته رسمیو است. استخراج این
  ...
  ads: {
    ...
    subtitle:
      'هر روز تبلیغات جدیدی می‌بینیم، در تلویزیون، در مجلات، گوشی تلفن‌همراهی که در دست داریم، سایت‌هایی که به آن‌ها سر می‌زنیم و هزاران جای دیگر. اگر تبلیغ در زمان و مکان درست به ما نرسد عملا با دورریختن پول فرقی ندارد. اگر به دنبال رسانه‌ای هستید که روزانه صد هزار از فعالان اقتصادی ایران به آن سر بزنند و شما دقیقا به هدف بزنید، رسمیو دقیقا همین رسانه است.',
  },
  api: {},
  companies: {
    title: 'تاریخچه‌ای از فعالیت‌های یک شرکت در دستان شما',
    subtitle:
      'تنها ابزاری در ایران که همه اطلاعات رسمی منتشر شده درباره یک شرکت را یکجا جمع و قابل جستجو کرده، پروفایل شرکت‌ها در رسمیو است.',
    list: {
      title: 'زمانی که...',
      items: [
  ...
  graph: {
    ...
    answers: {
      title:
        'جواب این سوال‌ها فقط با ابزار شبکه ارتباطی رسمیو قابل جوابگویی است',
      item: (
        <div data-selector='answer'>
  ...
  persons: {
    ...
    answers: {
      title:
        'جواب این سوالات را می‌توانید از سرویس پروفایل افراد در شرکت‌های رسمیو دریافت کنید.',
      item: (
        <div data-selector='answer'>
          <div>
          ...
          <div data-selector='answer-2nd'>
            از طرفی اگر بخواهید می‌توانید پروفایل خود در سایت رسمیو را کامل کنید
